...
export default {
  ...
  theme: {
    extend: {
      ...
      textStrokeColor: {
        white: "#FFF",
        col100: "rgba(228, 237, 245, 1)",
        col170: "rgba(228, 237, 245, 0.7)",
        col180: "rgba(228, 237, 245, 0.8)",
        col190: "rgba(228, 237, 245, 0.9)",

        col200: "rgba(208, 226, 242, 1)",
        col270: "rgba(208, 226, 242, 0.7)",
        col280: "rgba(208, 226, 242, 0.8)",
        col290: "rgba(208, 226, 242, 0.9)",

        col300: "rgba(217, 181, 173, 1)",
        col370: "rgba(217, 181, 173, 0.7)",
        col380: "rgba(217, 181, 173, 0.8)",
        col390: "rgba(217, 181, 173, 0.9)",

        col400: "rgba(167, 189, 217, 1)",
        col470: "rgba(167, 189, 217, 0.7)",
        col480: "rgba(167, 189, 217, 0.8)",
        col490: "rgba(167, 189, 217, 0.9)",

        col500: "rgba(84, 123, 171, 1)",
        col570: "rgba(84, 123, 171, 0.7)",
        col580: "rgba(84, 123, 171, 0.8)",
        col590: "rgba(84, 123, 171, 0.9)",

        black: "#000",

        col600: "rgba(97, 116, 140, 1)",
        col670: "rgba(97, 116, 140, 0.7)",
        col680: "rgba(97, 116, 140, 0.8)",
        col690: "rgba(97, 116, 140, 0.9)",

        col700: "rgba(41, 60, 84, 1)",
        col770: "rgba(41, 60, 84, 0.7)",
        col780: "rgba(41, 60, 84, 0.8)",
        col790: "rgba(41, 60, 84, 0.9)",

        col800: "rgba(1, 42, 94, 1)",
        col870: "rgba(1, 42, 94, 0.7)",
        col880: "rgba(1, 42, 94, 0.8)",
        col890: "rgba(1, 42, 94, 0.9)",

        col900: "rgba(1, 17, 38, 1)",
        col970: "rgba(1, 17, 38, 0.7)",
        col980: "rgba(1, 17, 38, 0.8)",
        col990: "rgba(1, 17, 38, 0.9)",
      },
      backgroundImage: {
        // FadeOut Gradients
        fadeOut900Op07:
