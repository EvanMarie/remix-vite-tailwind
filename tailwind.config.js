  ...
  theme: {
    extend: {
      ...
      textStrokeColor: {
        ...
        col110: "rgba(228, 237, 245, 0.1)",
        col120: "rgba(228, 237, 245, 0.2)",
        col130: "rgba(228, 237, 245, 0.3)",
        col140: "rgba(228, 237, 245, 0.4)",
        col150: "rgba(228, 237, 245, 0.5)",
        col160: "rgba(228, 237, 245, 0.6)",
        col170: "rgba(228, 237, 245, 0.7)",
        col180: "rgba(228, 237, 245, 0.8)",
        col190: "rgba(228, 237, 245, 0.9)",

        col200: "rgba(208, 226, 242, 1)",
        col210: "rgba(208, 226, 242, 0.1)",
        col220: "rgba(208, 226, 242, 0.2)",
        col230: "rgba(208, 226, 242, 0.3)",
        col240: "rgba(208, 226, 242, 0.4)",
        col250: "rgba(208, 226, 242, 0.5)",
        col260: "rgba(208, 226, 242, 0.6)",
        col270: "rgba(208, 226, 242, 0.7)",
        col280: "rgba(208, 226, 242, 0.8)",
        col290: "rgba(208, 226, 242, 0.9)",

        col300: "rgba(217, 181, 173, 1)",
        col310: "rgba(217, 181, 173, 0.1)",
        col320: "rgba(217, 181, 173, 0.2)",
        col330: "rgba(217, 181, 173, 0.3)",
        col340: "rgba(217, 181, 173, 0.4)",
        col350: "rgba(217, 181, 173, 0.5)",
        col360: "rgba(217, 181, 173, 0.6)",
        col370: "rgba(217, 181, 173, 0.7)",
        col380: "rgba(217, 181, 173, 0.8)",
        col390: "rgba(217, 181, 173, 0.9)",

        col400: "rgba(167, 189, 217, 1)",
        col410: "rgba(167, 189, 217, 0.1)",
        col420: "rgba(167, 189, 217, 0.2)",
        col430: "rgba(167, 189, 217, 0.3)",
        col440: "rgba(167, 189, 217, 0.4)",
        col450: "rgba(167, 189, 217, 0.5)",
        col460: "rgba(167, 189, 217, 0.6)",
        col470: "rgba(167, 189, 217, 0.7)",
        col480: "rgba(167, 189, 217, 0.8)",
        col490: "rgba(167, 189, 217, 0.9)",

        col500: "rgba(84, 123, 171, 1)",
        col510: "rgba(84, 123, 171, 0.1)",
        col520: "rgba(84, 123, 171, 0.2)",
        col530: "rgba(84, 123, 171, 0.3)",
        col540: "rgba(84, 123, 171, 0.4)",
        col550: "rgba(84, 123, 171, 0.5)",
        col560: "rgba(84, 123, 171, 0.6)",
        col570: "rgba(84, 123, 171, 0.7)",
        col580: "rgba(84, 123, 171, 0.8)",
        col590: "rgba(84, 123, 171, 0.9)",

        col600: "rgba(97, 116, 140, 1)",
        col610: "rgba(97, 116, 140, 0.1)",
        col620: "rgba(97, 116, 140, 0.2)",
        col630: "rgba(97, 116, 140, 0.3)",
        col640: "rgba(97, 116, 140, 0.4)",
        col650: "rgba(97, 116, 140, 0.5)",
        col660: "rgba(97, 116, 140, 0.6)",
        col670: "rgba(97, 116, 140, 0.7)",
        col680: "rgba(97, 116, 140, 0.8)",
        col690: "rgba(97, 116, 140, 0.9)",

        col700: "rgba(41, 60, 84, 1)",
        col710: "rgba(41, 60, 84, 0.1)",
        col720: "rgba(41, 60, 84, 0.2)",
        col730: "rgba(41, 60, 84, 0.3)",
        col740: "rgba(41, 60, 84, 0.4)",
        col750: "rgba(41, 60, 84, 0.5)",
        col760: "rgba(41, 60, 84, 0.6)",
        col770: "rgba(41, 60, 84, 0.7)",
        col780: "rgba(41, 60, 84, 0.8)",
        col790: "rgba(41, 60, 84, 0.9)",

        col800: "rgba(1, 42, 94, 1)",
        col810: "rgba(1, 42, 94, 0.1)",
        col820: "rgba(1, 42, 94, 0.2)",
        col830: "rgba(1, 42, 94, 0.3)",
        col840: "rgba(1, 42, 94, 0.4)",
        col850: "rgba(1, 42, 94, 0.5)",
        col860: "rgba(1, 42, 94, 0.6)",
        col870: "rgba(1, 42, 94, 0.7)",
        col880: "rgba(1, 42, 94, 0.8)",
        col890: "rgba(1, 42, 94, 0.9)",

        col900: "rgba(1, 17, 38, 1)",
        col910: "rgba(1, 17, 38, 0.1)",
        col920: "rgba(1, 17, 38, 0.2)",
        col930: "rgba(1, 17, 38, 0.3)",
        col940: "rgba(1, 17, 38, 0.4)",
        col950: "rgba(1, 17, 38, 0.5)",
        col960: "rgba(1, 17, 38, 0.6)",
