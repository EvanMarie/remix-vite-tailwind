...
export const DateTimePickerStyles = `text-md text-col-100 absolute mt-[1vh] p-[1.5vh] w-[25vh] px-[1.5vh] py-[0.5vh] justify-center items-center textShadow bg-col-930 shadowNarrowNormal z-20`;
