            ...
            <>
              ...
              >
                <Flex className="w-full h-full relative ">
                  ...
                  <Flex className="w-full h-full justify-between bg-cyanBack border-l-3 border-dt-900">
                    ...
                    <Flex className="w-full h-[50px] bg-darkGrayBack rounded-t-none border-t-2 border-dt-850 justify-center flex-shrink-0 absolute bottom-0 left-0">
